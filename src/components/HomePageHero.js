...
const HomePageHero = () => (
  <div className="relative bg-gray-50 overflow-hidden">
    ...
    >
      ...
      <div x-show="open" className="absolute top-0 inset-x-0 p-2 md:hidden">
      ...
      <div className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
        <div className="text-center">
          <h2 className="text-4xl tracking-tight leading-10 font-extrabold text-gray-900 sm:text-5xl sm:leading-none md:text-6xl">
            ...
            <span className="text-indigo-600"> for all things Javascript</span>
          </h2>
          <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
            New tutorials and posts weekly on Javascript, React, Node, Gatsby, JAMStack, Typescript, React Native, GraphQL, Programming, Git, CSS
          </p>
